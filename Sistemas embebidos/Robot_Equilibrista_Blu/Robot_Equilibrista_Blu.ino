...
MPU6050 mpu;
//*************************************** Ajustes ***************************************
double MotorVelocidadIzq = 0.35; //double MotorVelocidadIzq = 0.3;
double MotorVelocidadDer = 0.3; //double MotorVelocidadDer = 0.3;
double PuntoEquilibrio = 177.8;
//double PuntoEquilibrio = 178;
